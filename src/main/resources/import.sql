...
/* usuarios */
insert into users (username, password, enabled) values ('admin', '$2a$10$DMDVQp1y/fpY2HGRxJiVle91ojDGh3JlyBbMQ1GYJa09lH6nv8kFe', 1);
insert into users (username, password, enabled) values ('andres', '$2a$10$FSl.WMburcmqSEk11FhBwuWYcX2BFrWIhOBLQXpm7KzB0bsFQP94y', 1);
